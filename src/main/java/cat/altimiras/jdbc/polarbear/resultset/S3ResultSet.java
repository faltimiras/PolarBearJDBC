...
public class S3ResultSet extends PolarBearResultSet {
	...
	public S3ResultSet(List<Field> queryFields, TableDefinition tableDefinition, S3FilesIterator s3FilesIterator,
		Planner planner, Statement statement) throws PolarBearException {
